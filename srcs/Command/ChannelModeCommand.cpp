...
void ChannelModeCommand::_retrieveChannelModes(void) {
    ...
    // Else If Invoker is in channel (no matter he's chanop or not)
        // :f10c4f1ecd09.example.com 324 foo #tardis :+inpt
        // :f10c4f1ecd09.example.com 329 foo #tardis :1656335996
	Channel*	channel = _command.getChannel(_command.getParameters()[0]); // TODO - remove false when Jorys update method
	if (!channel)
		return ;// TODO - Add 403
