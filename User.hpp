...
//object unser recupere la commande et la stocke dans l'objet commande - string buffer

//tableau de commandes dans user => std::queue ctr pours stocker les commandes

//pas de fd a gerer

//pas de liste d'users - elle sera dans le server

//tableau de responses pour le server std::queue = > "send"
...
// faire la fonction write pour remplir le tableau des responses

// NE PA FAIRE PUSH => server
